...
<head>
	...
	<!-- Fonts and icons -->
	<script src="login/assets/js/plugin/webfont/webfont.min.js"></script>
	<script>
		WebFont.load({
			google: {"families":["Open+Sans:300,400,600,700"]},
			custom: {"families":["Flaticon", "Font Awesome 5 Solid", "Font Awesome 5 Regular", "Font Awesome 5 Brands"], urls: ['login/assets/css/fonts.css']},
			active: function() {
	...
	<link rel="stylesheet" href="login/assets/css/azzara.min.css">
</head>
<body class="login">
		...
		<div class="container container-login animated fadeIn">
			...
			<div class="login-form">
				...
				<div class="form-group form-action-d-flex mb-3">
                    ...
                    {{-- <a href="/" class="btn btn-primary col-md-5 float-right mt-3 mt-sm-0 fw-bold">kembali</a> --}}
				</div>
	...
	<script src="login/assets/js/core/jquery.3.2.1.min.js"></script>
	<script src="login/assets/js/plugin/jquery-ui-1.12.1.custom/jquery-ui.min.js"></script>
	<script src="login/assets/js/core/popper.min.js"></script>
	<script src="login/assets/js/core/bootstrap.min.js"></script>
	<script src="login/assets/js/ready.js"></script>
</body>
</html>